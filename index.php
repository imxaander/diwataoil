                            ...
                            <div class="product-card">
                                    <div class="product-image">
                                        <div class="w3-content w3-display-container">
                                            <img class="mySlides<?php echo $row['id']?>" src="img/<?php echo $row['image1']?>" style="width:100%">
                                            <img class="mySlides<?php echo $row['id']?>" src="img/<?php echo $row['image2']?>" style="width:100%">
